...
/**
 * Servicio encargado de la migración de imágenes almacenadas en Base64
 * hacia el microservicio de almacenamiento (Coral Storage) y su posterior registro
 * en la tabla ADJUNTOS_NOTAS_CLIENTES.
 */
@Service
@Slf4j
public class NotasClientesMigrationService {
    ...
    public NotasClientesMigrationService(
    ...
    public void ejecutarMigracionAsync() {
        log.info("Iniciando migración de imágenes en segundo plano (asíncrono)...");
        ejecutarMigracion();
    }

    /**
     * Ejecuta el proceso de migración de forma síncrona.
     */
    public void ejecutarMigracion() {
        ...
        for (Map<String, Object> record : records) {
            ...
            try {
                ...
                // Cargar síncronamente a Coral Storage (usando el StorageClient con 5m timeout)
