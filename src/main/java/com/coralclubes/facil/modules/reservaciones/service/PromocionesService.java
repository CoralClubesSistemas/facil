...
public class PromocionesService {
    ...
    public ApiResponse<Integer> guardarPromocion(PromocionIntegralRequest request) {
        ...
        Integer nuevoId = repository.spResvGuardarPromocionIntegral(request, usuario).orElseThrow(() -> new ServiceUnavailableException("No se pudo guardar la promoción. Revise que el código no esté duplicado."));
    ...
    public ApiResponse<Boolean> eliminarPromocion(Integer idPromocion) {
        ...
        UUID uuidImagen = repository.spResvObtenerUuidImagenPromocion(idPromocion).orElse(null);
    ...
    public Promocion validarCodigoInterno(String codigo) {
        return repository.spResvObtenerPromocionPorCodigo(codigo).orElse(null);
    }
    ...
    public ApiResponse<Integer> aplicarConsumoOferta(ConsumoOfertaRequest request) {
        ...
        Integer idAplicacion = repository.spResvDetallarConsumoOferta(request, usuarioAplicacion).orElseThrow(() -> new ServiceUnavailableException("Error al aplicar la promoción. Posible falta de stock de último segundo."));
