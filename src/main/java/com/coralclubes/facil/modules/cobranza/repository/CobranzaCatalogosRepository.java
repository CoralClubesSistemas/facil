...
public class CobranzaCatalogosRepository {
    ...
    public List<SelectGenerico<Integer>> spCobranzaCatalogoTemporadas() {
        return spExecutor.queryList("spCobranzaCatalogoTemporadas", Collections.emptyMap(), selectGenericoMapper);
    }

    public List<SelectGenerico<Integer>> spCobranzaCatalogoDias() {
        return spExecutor.queryList("spCobranzaCatalogoDias", Collections.emptyMap(), selectGenericoMapper);
    }

    public List<SelectGenerico<Integer>> spCobranzaCatalogoClasificacionesMembresias(Integer idDesarrollo) {
        Map<String, Object> params = new HashMap<>();
        params.put("desarrollo", idDesarrollo);

        return spExecutor.queryList("spCobranzaCatalogoClasificacionesMembresias", params, selectGenericoMapper);
    }
    ...
    public List<SelectGenerico<Integer>> spCobranzaCatalogoProcedenciaPaqueteAnual() {
        return spExecutor.queryList("spCobranzaCatalogoProcedenciaPaqueteAnual", Collections.emptyMap(), selectGenericoMapper);
    }
}
